# Ψ ↔ λμ/CPS Structural Mapping - v0.1
...
This is a **correspondence / mapping** document. It is not claiming a proved bijective structure-preserving isomorphism.
...
## 4. Structural mapping: λμ-Calculus and CPS
...
* **Computational Grounding:** The mapping to CPS reinforces the idea that the Ψ formalism is grounded in fundamental computational principles, suggesting potential pathways for direct implementation.
...
* A full, formal proof of a λμ-calculus ↔ CPS isomorphism.
