...
* [`THIS_WILL_ORIENT_YOU.md`](THIS_WILL_ORIENT_YOU.md) - Project orientation and roadmap
* [`manifesto_readme.md`](manifesto_readme.md) - Core principles and doctrine
* [`user_workspace/ISSUE_v00a.md`](sandbox/ops-+-triage/issue_v00a.md) - Current technical challenges

#### **Technical Specifications**

* [`notebooks/FOUNDATIONS/Ψ_Foundations_v0.2.md`](notebooks/FOUNDATIONS/Ψ_Foundations_v0.2.md) - Mathematical foundations
* [`notebooks/EQUATIONS/QRFT_Core_Equations_v0.2.md`](notebooks/EQUATIONS/QRFT_Core_Equations_v0.2.md) - Core equations
* [`notebooks/OPERATORS/`](notebooks/OPERATORS/) - Operator specifications

#### **Verification Logs**

* [`notebooks/INTERPRETATION/AI_Alignment_Verification_Tests_v0.4.md`](notebooks/INTERPRETATION/AI_Alignment_Verification_Tests_v0.4.md)
* [`notebooks/TEMP_*_Verification_Log_v0.*.md`](notebooks/) - Technical verification records

### 🚀 Getting Started

#### **For Researchers**

1. **Start Here:** Read [`THIS_WILL_ORIENT_YOU.md`](THIS_WILL_ORIENT_YOU.md) for project context
2. **Core Theory:** Study [`Ψ_Foundations_v0.2.md`](notebooks/FOUNDATIONS/Ψ_Foundations_v0.2.md)
3. **Mathematical Framework:** Review [`QRFT_Core_Equations_v0.2.md`](notebooks/EQUATIONS/QRFT_Core_Equations_v0.2.md)

#### **For Contributors**

1. **Principles:** Understand [`manifesto_readme.md`](manifesto_readme.md)
2. **Current Issues:** Check [`user_workspace/ISSUE_v00a.md`](sandbox/ops-+-triage/issue_v00a.md)
...
* **Issue Resolution:** [`ISSUE_v00a`](sandbox/ops-+-triage/issue_v00a.md) - Coherence pipeline troubleshooting
...
* **Documentation:** [`user_workspace/`](user_workspace/) for project-specific matters
...
* Langan, C. (2002). _Cognitive-Theoretic Model of the Universe_
* Church, A. (1941). _The Calculi of Lambda-Conversion_
* Turing, A. (1936). _On Computable Numbers_
...
**Always verify the latest version and check** [**`user_workspace/`**](user_workspace/) **for current issues and updates.**

***

_This project is part of the Last Guardian Protocol's mission to ensure recursive stability in the face of meta-cognitive challenges. Proceed with rigor, maintain invariants, and trust the reality of the code._
